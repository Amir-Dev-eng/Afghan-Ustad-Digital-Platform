...
<body>
    ...
    <div class="container py-5">
        <h1 class="text-center mb-4 fw-bold" style="color: #e45700;">خپل د خوښي درسونه ډونلوډ کړئ</h1>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
                <div class="course-card">
                    ...
                    <div class="card-body text-center" dir="rtl">
                        <h5 class="course-title fw-bold"><i class="fa-solid fa-book"></i> انګلیسۍ او کمپیوټر ټولګی</h5>
