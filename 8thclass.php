...
.modern-dropdown {
  background: #0B2CAD;              /* د navbar سره match */
  border: none;
  border-radius: 14px;
  padding: 8px 0;
  min-width: 240px;
        ...
        <div class="container">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu modern-dropdown text-center" dir="rtl" aria-labelledby="coursesDropdown">
              <li><h4><a class="dropdown-item text-center fw-bold" href="all-courses.php" style="color:#FF6A00;">ټــول کورســـونــه</a></h4></li>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
                <div class="course-card">
                    ...
                    <div class="card-body" dir="rtl">
                        <h5 class="course-title"><i class="fa-solid fa-book"></i> اتم ټولګی ریاضي</h5>
                        ...
                        <a href="all-courses.php" class="btn btn-primary rounded-pill mt-4 w-100" style=" background-color: #FF6A00;">
                            <i class="fa-solid fa-download me-2"></i> د درسونو عمومي صفحې ته لاړ شئ
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
                <div class="course-card">
                    ...
                    <div class="card-body" dir="rtl">
                        <h5 class="course-title"><i class="fa-solid fa-book"></i> اتم ټولګی فزیک</h5>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
                <div class="course-card">
                    ...
                    <div class="card-body" dir="rtl">
                        <h5 class="course-title"><i class="fa-solid fa-book"></i> اتم ټولګی کیمیا</h5>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
                <div class="course-card">
                    ...
                    <div class="card-body" dir="rtl">
                        <h5 class="course-title"><i class="fa-solid fa-book"></i> اتم ټولګی انګلیسۍ</h5>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 d-flex justify-content-center">
                <div class="course-card">
                    ...
                    <div class="card-body" dir="rtl">
                        <h5 class="course-title"><i class="fa-solid fa-book"></i> اتم ټولګی بیولوژي</h5>
